...
const AllFields: readonly TableField[] = [
    ...
    { name: "totalSize", label: "Общий размер", component: ByteSizeField },
    { name: "sizeWhenDone", label: "Загружено", component: ByteSizeField },
    { name: "leftUntilDone", label: "Осталось", component: ByteSizeField },
    { name: "haveValid", label: "В наличии", component: ByteSizeField },
    { name: "downloadedEver", label: "Получено", component: ByteSizeField },
    { name: "uploadedEver", label: "Роздано", component: ByteSizeField },
    {
        name: "uploadedEver",
        label: "Роздано/Получено",
    ...
    { name: "rateDownload", label: "Скорость загрузки", component: ByteRateField },
    { name: "rateUpload", label: "Скорость раздачи", component: ByteRateField },
    { name: "status", label: "Статус", component: StatusField },
    { name: "addedDate", label: "Добавлен", component: DateField },
    {
    ...
    { name: "eta", label: "Осталось", component: EtaField },
    { name: "uploadRatio", label: "Рейтинг", component: FixedDecimalField },
    {
        name: "trackerStats",
        label: "Трекер",
    ...
    { name: "doneDate", label: "Завершено", component: DateField },
    { name: "activityDate", label: "Последняя активность", component: DateDiffField },
    { name: "downloadDir", label: "Путь", component: StringField },
    { name: "bandwidthPriority", label: "Приоритет", component: PriorityField },
    { name: "id", label: "ID", component: PositiveNumberField },
    { name: "queuePosition", label: "Очередность", component: PositiveNumberField },
    { name: "secondsSeeding", label: "Время сидирования", component: TimeField },
    { name: "isPrivate", label: "Приватный", component: StringField },
    { name: "labels", label: "Метки", component: LabelsField },
    { name: "group", label: "Ограничение", component: StringField },
    { name: "file-count", label: "Файлов", component: PositiveNumberField },
    { name: "pieceCount", label: "Частей", component: PositiveNumberField },
    { name: "metadataPercentComplete", label: "Метаданные", component: PercentBarField },
] as const;
    ...
    const updateTorrentName = useCallback((name: string, onStart: () => void, onEnd: () => void) => {
        ...
        if (name === path) {
            ...
            mutation.mutate(
                ...
                {
                    onSettled: onEnd,
                    onError: () => { notifications.show({ color: "red", message: "Не удалось переименовать торрент" }); },
                });
        }
